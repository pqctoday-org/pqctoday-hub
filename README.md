...
- **Cryptography**:
  ...
  - `pqctoday-kmip` / `softhsmrustv3` (v0.13.1) — the in-browser KMIP 3.0 crypto-agility control plane behind `/playground/cacp`: policy engine + PKCS#11 v3.2 Rust engine compiled to WASM; ML-KEM / ML-DSA / SLH-DSA / RSA / ECDSA / Ed25519 / AES, classical X25519/X448 key agreement, hybrid X25519MLKEM768, pure-Rust certificate operations (Certify/Validate/SPKI verify), label-only policy-driven migration with rekey-on-use
