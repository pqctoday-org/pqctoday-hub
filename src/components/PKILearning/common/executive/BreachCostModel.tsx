          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <p className="text-[10px] text-muted-foreground mt-1">
                ...
                because IRIS 2025's finding is that they have converged: small-firm risk has more
                than doubled since 2008 while the largest firms' has fallen. Drag the slider to
                override.
              </p>
            </div>
          </div>
