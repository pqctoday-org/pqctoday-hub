  ...
  switch (stepIdx) {
    ...
    case 7: {
      ...
      return [
        ...
        '',
        '  PQC Mechanism Flags:',
        '  ML-KEM (0x00000017): CKF_GENERATE_KEY_PAIR | CKF_ENCAPSULATE | CKF_DECAPSULATE',
        '  ML-DSA (0x0000001d): CKF_GENERATE_KEY_PAIR | CKF_SIGN | CKF_VERIFY',
        '  SLH-DSA(0x0000002e): CKF_GENERATE_KEY_PAIR | CKF_SIGN | CKF_VERIFY',
        '',
