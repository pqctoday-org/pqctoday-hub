...
/**
 * Render-parity golden test for the CryptoDevAPIs ModuleShell conversion.
 * Captured against the PRE-conversion module; must stay green after
 * CryptoDevAPIs adopts <ModuleShell>, proving the conversion is
...
import { CryptoDevAPIsModule } from './index'

describe('CryptoDevAPIs render parity', () => {
  it('renders the gradient header, the in-page description, and all six tabs', () => {
    ...
    expect(
      screen.getByRole('heading', { name: 'Cryptographic APIs & Developer Languages' })
    ).toBeInTheDocument()
