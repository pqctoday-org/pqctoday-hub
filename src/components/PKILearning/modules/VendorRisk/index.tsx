...
function ExercisesTab() {
  const exercises = [
    ...
    },
    {
      ...
      prompt:
        'Your compliance team discovered that several vendors claim "FIPS compliance" but only have FIPS 140-2 validation (not 140-3). The CMVP stopped accepting FIPS 140-2 submissions for new validation certificates on 22 September 2021, making FIPS 140-3 the only path for new certifications. You need to audit your vendor portfolio and replace FIPS 140-2-only products in critical roles. Score at least 3 vendors using the Vendor Scorecard and generate contract clauses that distinguish between FIPS 140-2 and 140-3 requirements.',
    },
  ]
