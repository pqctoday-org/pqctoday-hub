...
import { Trash2, Calculator, Award } from 'lucide-react'
...
const MODULE_ID = 'skills-team-structure'
...
export const SkillsTeamStructureModule: React.FC = () => {
  ...
  const handleReset = () => {
    if (confirm('Restart Skills & Team Structure Module?')) {
      setCurrentPart(0)
      startTimeRef.current = Date.now()
      updateModuleProgress(MODULE_ID, {
        status: 'in-progress',
    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Staff a post-quantum migration program: the core roles, an estate-driven sizing
            heuristic, build/borrow/buy sourcing, the four training levels, and the Crypto Champion
            Program.
          </p>
        </div>
      </div>
      ...
      <Tabs value={activeTab} onValueChange={handleTabChange}>
        ...
        <TabsContent value="workshop">
          <div className="max-w-7xl mx-auto space-y-6">
            ...
            <div className="glass-panel p-4 sm:p-6 md:p-8 min-h-[400px] md:min-h-[600px] animate-fade-in">
              ...
              />
              {currentPart === 0 && <TeamSizingCalculator />}
              {currentPart === 1 && <CryptoChampionBuilder />}
            </div>
        ...
        <TabsContent value="exercises">
          <SkillsTeamStructureExercises onNavigateToWorkshop={handleExerciseNavigate} />
        </TabsContent>
