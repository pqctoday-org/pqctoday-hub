 ...
 *    `crypto-product-certification/capstone`, `crypto-product-certification/change-analyzer`, `crypto-product-certification/evidence-exchange`, in the src/data/stepExercises.ts shape.
