...
export const PQCCandidatesModule: FC = () => (
  <ModuleShell
    ...
    description="How NIST evaluates new post-quantum mechanisms, the nine third-round signature on-ramp candidates (NIST IR 8610, May 2026) across four math families, and the worldwide parallel tracks that decide what actually ships."
