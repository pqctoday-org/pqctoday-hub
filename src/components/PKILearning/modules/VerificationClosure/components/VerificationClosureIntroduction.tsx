    ...
    <div className="space-y-5">
      ...
      <Section id="decommission" icon={Trash2} title="Retire classical crypto safely">
        <p>
          ...
          (highest-priority migration), 2035 (complete); <strong>NIST SP 800-131A</strong> carries
          the transition rules.
        </p>
        <p>
          The discipline is four steps: <strong>deprecate → remove → verify removed → log</strong>.
          The step teams skip is the third — confirm by observation that the old key material is
          gone, not just that a new key exists.
        </p>
        <Button
          variant="outline"
          size="sm"
      ...
      <Section id="verify-evidence" icon={Activity} title="Prove it from observed behaviour">
        <p>
          <Badge kind="view" />A system is &ldquo;migrated&rdquo; when its <em>behaviour</em> shows
          it — the handshake negotiates ML-KEM/ML-DSA — not when a change ticket says so. Reuse the{' '}
      ...
      <Section id="closure-handover" icon={Archive} title="Close into business-as-usual">
        <p>
          ...
          CBOM, continuous discovery, vendor cadence, SOC content, KRIs, crypto-agility — to
          permanent owners, with an archived <strong>evidence dossier</strong>.
        </p>
        <p>
          <Badge kind="std" />
