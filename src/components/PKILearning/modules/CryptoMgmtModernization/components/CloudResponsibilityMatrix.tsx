...
const CLOUD_PROVIDER_PRODUCTS: Record<string, { kmsHsm: string[]; tls: string[] }> = {
  ...
  Azure: {
    kmsHsm: ['Azure Key Vault', 'Azure Dedicated HSM (Marvell LiquidSecurity)'],
    tls: [],
  },
  Oracle: { kmsHsm: ['Oracle Key Vault'], tls: [] },
  IBM: { kmsHsm: ['IBM Hyper Protect Crypto Services'], tls: [] },
  Alibaba: { kmsHsm: ['Alibaba Cloud GVSM'], tls: [] },
  'on-prem': { kmsHsm: [], tls: [] },
...
const CITATION =
  'NIST CSWP 39 Section 6.4 (Crypto Agility in the Cloud) and Section 5.3 (Technology Supply Chains). https://doi.org/10.6028/NIST.CSWP.39-upd1'
...
export function renderCloudMatrixMarkdown(
  ...
  md += `*Generated by PQC Today Hub. Standards citations: NIST CSWP 39 Section 6.4, Section 5.3. https://doi.org/10.6028/NIST.CSWP.39-upd1*\n`
