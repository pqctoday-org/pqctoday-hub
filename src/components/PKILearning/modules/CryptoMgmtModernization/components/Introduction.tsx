  ...
  return (
    <div className="space-y-8 w-full">
      ...
      <section id="why-now" className="glass-panel p-6">
        ...
        <div className="space-y-4 text-sm text-foreground/80">
          ...
          <Quote cite="NIST CSWP.39 §5, Considerations for Achieving Crypto Agility (December 2025)">
            Inventory the use of cryptography for data protection across the organization by
            adopting an assets-centric approach &hellip; to identify the organization&rsquo;s use
            cases and most valuable assets,{' '}
          ...
          <p>
            ...
            it consumes live in an HSM that cannot rotate fast enough. Each driver below is already
            in force today.
          </p>
          <ul className="list-disc list-outside pl-5 space-y-2 text-sm">
            ...
            <li>
              ...
              through 2035, and EU DORA (Art. 9 &mdash; ICT risk management) and NIS2 (Art. 21
              &mdash; cybersecurity measures) demand demonstrable cryptographic governance across
              the entire application portfolio &mdash; not just the TLS edge.
            </li>
            <li>
      ...
      <section id="cswp39-plan" className="glass-panel p-6">
        ...
        <div className="space-y-4 text-sm text-foreground/80">
          <p>
            NIST CSWP.39 (December 2025, <em>Considerations for Achieving Crypto Agility</em>)
            defines the <strong>Crypto Agility Strategic Plan</strong> as a continuously repeated
            five-step process. CPM is the organisational discipline that executes this loop.
          </p>
          <ol className="space-y-2 list-decimal list-inside">
            ...
            <li>
              <strong>Implement</strong> — execute <em>Mitigation</em> (compensating controls /
              crypto gateway) or <em>Migration</em> (algorithm replacement) based on each
              asset&apos;s agility level.
            </li>
          </ol>
          <div className="bg-status-info/10 rounded-lg p-4 border border-status-info/30">
            <div className="flex items-start gap-2">
              ...
              <p className="text-xs text-muted-foreground">
                ...
                Fig. 3 framework — click any zone to see what belongs there, which CPM pillar it
                maps to, and the relevant CSWP.39 section.
              </p>
            </div>
          </div>
      ...
      <section id="management-tools" className="glass-panel p-6">
        ...
        <div className="space-y-4 text-sm text-foreground/80">
          <p>
            ...
            the Risk Analysis Engine. Without automation at this layer, the Information Repository
            is populated manually and the risk engine operates on incomplete, stale data.
          </p>
      ...
      <section id="cswp39-maturity" className="glass-panel p-6">
        ...
        <div className="space-y-4 text-sm text-foreground/80">
          <p>
            CSWP.39 §6.5 defines a 4-tier maturity model derived from the NIST Cybersecurity
            Framework (CSF). The Workshop&apos;s Maturity Self-Assessment maps your CPM score to the
              ...
              <tbody>
                <tr>
                  ...
                  <td className="p-2 border-b border-border text-muted-foreground">
                    Crypto practices unstructured; teams pick their own algorithms; no formal
                    policy; supply-chain crypto risks unknown.
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td className="p-2 border-b border-border text-muted-foreground">
                    Crypto agility formally integrated into risk management; roles defined;
                    automated discovery and remediation tools deployed; agility practices tested.
                  </td>
                </tr>
                <tr className="bg-muted/20">
      ...
      <section id="cpm-defined" className="glass-panel p-6">
        ...
        <div className="space-y-4 text-sm text-foreground/80">
          <p>
            Vendors and analysts routinely conflate three distinct layers. The module carves them
            out up front so your next conversation with a product, a consultant, or your board is
            unambiguous.
          </p>
          <div className="overflow-x-auto">
            <table className="w-full text-xs border border-border">
          ...
          <Quote cite="David Mahdi & Brian Lowans, Gartner (2023–2025)">
            ...
            posture management program will achieve approximately 50% lower total PQC transition
            cost than organizations that treat migration as a one-off project.
          </Quote>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
            <div className="bg-muted/50 rounded-lg p-3 border border-border">
              ...
              <p className="text-[11px] text-muted-foreground">
                Unified CBOM across the four asset classes. Continuously refreshed, not
                point-in-time.
              </p>
            </div>
            <div className="bg-muted/50 rounded-lg p-3 border border-border">
            ...
            <div className="bg-muted/50 rounded-lg p-3 border border-border">
              ...
              <p className="text-[11px] text-muted-foreground">
                Posture metrics, SIEM drift alerts, coverage trends. Feeds both loops of the
                iterative process.
              </p>
            </div>
            <div className="bg-muted/50 rounded-lg p-3 border border-border">
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  ...
                  revision is no longer implicitly compliant. The Assurance pillar subscribes to
                  CMVP change notices and flags drift within the same loop as CVE triage.
                </p>
              </div>
            </div>
          </div>
          <div className="bg-status-info/10 rounded-lg p-4 border border-status-info/30 mt-2">
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  A FIPS 140-3 algorithm certificate and an SP 800-90B Entropy Source Validation
                  (ESV) certificate are two separate CMVP submissions. A library or HSM can hold a
                  valid FIPS 140-3 certificate while its entropy source has never been independently
                ...
                <p className="text-xs text-muted-foreground mt-2">
                  ...
                  subscription that tracks FIPS 140-3 Implementation Guidance updates must also
                  track SP 800-90A/B/C revision publications and their effective dates. When a
                  revision is issued, the CBOM workflow should trigger an impact assessment: which
                  validated entropy sources are bound to the superseded revision, which require
                  re-testing under the new thresholds, and which vendor roadmaps commit to updated
                  ESV submissions.
                </p>
                <p className="text-xs text-muted-foreground mt-2">
                  {' '}
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  ...
                  <span className="text-xs text-muted-foreground">(IETF)</span> RFC 8996, 3DES
                  sunset by <span className="text-xs text-muted-foreground">(NIST)</span> SP
                  800-131A Rev 2, SHA-1 code-signing banned by CA/B Forum, RSA-1024 below NIST
                  minimum-security thresholds, RC4 prohibited by{' '}
                ...
                <p className="text-xs text-muted-foreground mt-2">
                  ...
                  includes reconfiguring cipher-suite preference lists in TLS termination points,
                  SSH server policies, IKEv2 proposals, and code-signing pipeline configurations,
                  each of which may have separate ownership and change-management tracks.
                </p>
                <p className="text-xs text-muted-foreground mt-2">
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-2">
                  ...
                  running a 3.1.x build. If CBOM completeness is below 80%, a significant fraction
                  of the affected surface is invisible until discovered manually. CBOM completeness
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-muted/50 rounded-lg p-4 border border-accent/30">
              <div className="font-bold text-accent mb-2">
                Operational continuous loop — 6 stages
              </div>
              <ul className="text-xs space-y-1 text-muted-foreground list-disc list-inside">
                <li>
                ...
                <li>
                  <strong>Classify</strong> &mdash; HNDL sensitivity, FIPS/CNSA scope, compliance
                  tags
                </li>
                <li>
                ...
                <li>
                  <strong>Attest</strong> &mdash; CMVP cert check, ACME renewal proof, audit
                  evidence
                </li>
                <li>
      ...
      <section id="program-office" className="glass-panel p-6">
        ...
        <div className="space-y-4 text-sm text-foreground/80">
          <p>
            A CPM program stalls when it is owned by nobody or owned by everyone. The five roles
            below map to pillar ownership; headcount scales with organizational complexity.
          </p>
          <div className="overflow-x-auto">
            <table className="w-full text-xs border border-border">
              <thead>
      ...
      <section id="lab-blueprint" className="glass-panel p-6">
        ...
        <div className="space-y-4 text-sm text-foreground/80">
          <p>
            Crypto changes — library upgrades, HSM firmware, CA rotation, cipher-suite
            reconfiguration — must be validated in an isolated environment before touching
            production. The lab below is the minimum viable configuration; scale it to your risk
            profile.
          </p>
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <ul className="text-xs space-y-1.5 text-muted-foreground list-disc list-inside">
                  <li>
                    <strong>1× FIPS 140-3 L3 network-attached HSM</strong> — Thales Luna Network HSM
                    7 or Entrust nShield 5c recommended for PQC boundary coverage. Used for key
                  ...
                  <li>
                    ...
                    representative IoT/embedded device sample for constrained-env library
                    validation.
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="text-xs space-y-1.5 text-muted-foreground list-disc list-inside">
                  ...
                  <li>
                    ...
                    or open-source tooling (crt.sh lookups + custom scripts) for shadow-cert
                    discovery in the lab network.
                  </li>
                  <li>
                    <strong>SBOM generator → CBOM enrichment pipeline</strong> — Syft or cdxgen
                    generates CycloneDX SBOM; enrichment maps crypto components to CMVP status and
                    PQC readiness.
                  </li>
                  <li>
          ...
          <div className="bg-muted/50 rounded-lg p-4 border border-border">
            ...
            <ul className="text-xs space-y-1 text-muted-foreground list-disc list-inside">
              <li>
                VLAN-segregated from production; no direct internet routing (proxy only for
                NIST/CMVP lookups).
              </li>
              <li>
          ...
          <div className="bg-accent/5 rounded-lg p-4 border border-accent/20">
            ...
            <ol className="text-xs space-y-2 text-muted-foreground list-decimal list-inside">
              <li>
                <strong>Cipher-suite / protocol-version change:</strong> cipher-suite scan clean
                (all endpoints negotiate approved suites), testssl.sh report attached, no deprecated
                protocol negotiated.
              </li>
              <li>
              ...
              <li>
                ...
                relying-party systems updated and re-tested, CRL/OCSP propagation verified, expiry
                of new certs entered in CLM system.
              </li>
              <li>
                <strong>Protocol deprecation rollout:</strong> all endpoints in scope confirmed
                non-negotiating of deprecated protocol by passive scan; rollback procedure
                documented and tested; SIEM drift-alert rule updated for the new policy baseline.
              </li>
            </ol>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
            <div className="bg-muted/40 rounded-lg p-3 border border-border">
              ...
              <p className="text-muted-foreground">
                ...
                CSWP.39 Tier 1 spans two Meta levels (PQ-Unaware and PQ-Aware) because the spec
                treats both as &ldquo;Partial&rdquo; practice.
              </p>
            </div>
            <div className="bg-muted/40 rounded-lg p-3 border border-border">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-xs text-muted-foreground mt-0.5">
                Rafael Misoczki, Isaac Elbaz, Forrest Mertens &mdash; Meta Engineering &middot;
                April 2026
              </div>
