...
export function renderHybridTransitionMarkdown(
  ...
  md += `---\n\n`
  md += `*Generated by PQC Today Hub. Standards citation: NIST CSWP 39 Section 3.2.4 (Hybrid Cryptographic Algorithms), Fig.1. https://doi.org/10.6028/NIST.CSWP.39-upd1*\n`
