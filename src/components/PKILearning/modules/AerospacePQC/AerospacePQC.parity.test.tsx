...
/**
 * Render-parity golden test for the AerospacePQC ModuleShell conversion.
 * Captured against the PRE-conversion module; must stay green after AerospacePQC
...
import { AerospacePQCModule } from './index'

describe('AerospacePQC render parity', () => {
