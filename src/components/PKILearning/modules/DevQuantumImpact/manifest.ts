...
const manifest: ModuleManifest = {
  ...
  startHere: {
    ...
    text: 'Score yourself on the nine developer competencies in the Skill Self-Assessment: the result says which of the three earlier steps to go back to first.',
  },
