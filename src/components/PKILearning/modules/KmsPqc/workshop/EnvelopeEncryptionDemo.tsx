              ...
              <p className="text-xs text-muted-foreground">
                ...
                {displayStep.step === 4 &&
                  `AES-KW (RFC 3394), AES-KWP (RFC 5649), or AES-GCM (SP 800-38D) wraps the 32-byte DEK. ` +
                    ...
                    `Note: C_EncapsulateKey and C_DecapsulateKey are new in PKCS#11 v3.2 (OASIS Committee Specification 01, Nov 2025) — classic PKCS#11 had no native KEM primitives.`}
                {displayStep.step === 5 &&
