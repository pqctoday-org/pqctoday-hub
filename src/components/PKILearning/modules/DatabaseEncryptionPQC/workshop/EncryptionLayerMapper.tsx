...
const LAYER_INFO: LayerInfo[] = [
  {
    ...
    pqcUpgradePath:
      'Replace ECDH key agreement with ML-KEM-768 or ML-KEM-1024. Update application crypto library (OpenSSL 3.5+, Bouncy Castle 1.79+). Symmetric AES-256-GCM unchanged.',
    depth: 'Outermost',
  },
  {
    id: 'queryable',
