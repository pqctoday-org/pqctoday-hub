    ...
    <div className="h-full flex flex-col animate-fade-in">
      ...
      {!embedded && (
        <PageHeader
          ...
          description="Interactive OpenSSL v3.6.2 environment running entirely in your browser via WebAssembly. Educational use only — not a FIPS-validated module; PQC algorithm validation (FIPS 203/204/205) is pending for the 3.6.x line."
          viewType="Library"
          shareTitle="OpenSSL Studio — Interactive OpenSSL v3.6.2 in Your Browser"
          shareText="Run real OpenSSL 3.6.2 commands — key generation, certificates, KEM, PQC — entirely in your browser via WebAssembly."
        />
      )}
