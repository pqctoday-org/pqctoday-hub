              ...
              className={
                isSidebarLayout
                  ? isNarrowSidebar
                    ? isActive
                      ? navActiveBg
                        ? 'w-full flex-col justify-center items-center text-primary-foreground h-auto py-2 px-1 rounded-md gap-0.5'
                    ...
                    : isActive
                      ? navActiveBg
                        ? 'w-full justify-start text-primary-foreground h-auto py-2 px-3 rounded-md'
