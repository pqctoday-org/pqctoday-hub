...
function migrationRoadmap(sector: DemoSector): DemoDoc {
  return {
    ...
    data: md(
      ...
      '',
      '## Milestone Gates',
      '- G0: Charter, budget & QRPM approved; G1: Scoping done, Priority-A ≥90%, classical findings reported, continuous discovery live; G2: CBOM live, freshness governance enforced; G3: CBOM scored; QRA delivered',
      '',
