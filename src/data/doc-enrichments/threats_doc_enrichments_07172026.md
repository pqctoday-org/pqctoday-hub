...
- **Math Family**: None detected
- **PQC Round**: Not Applicable
- **Source Document**: AUTO-003.html (565,911 bytes, 17,735 extracted chars)
...
- **Math Family**: None detected
- **PQC Round**: Not Applicable
- **Source Document**: CLOUD-002.html (85,668 bytes, 6,823 extracted chars)
- **Extraction Timestamp**: 2026-07-17T10:43:52
- **Generation Model**: mlx-community/Qwen3.6-27B-8bit (mlx)
...
- **Last Updated**: Not specified
- **Document Status**: active
- **Main Topic**: Payment card environments face quantum risks as TLS 1.2 remains the PCI DSS minimum and EMVCo chip authentication relies on RSA, while PCI DSS 4.0 does not yet mandate PQC algorithms.
- **PQC Algorithms Covered**: None detected
- **Quantum Threats Addressed**: None detected
- **Migration Timeline Info**: Requirement 12.3.3’s cipher inventory mandate became firm on April 1, 2025
- **Applicable Regions / Bodies**: Bodies: PCI SSC, EMVCo
- **Leaders Contributions Mentioned**: None detected
- **PQC Products Mentioned**: None detected
- **Protocols Covered**: TLS 1.2
- **Infrastructure Layers**: None detected
- **Standardization Bodies**: PCI SSC, EMVCo
- **Compliance Frameworks Referenced**: PCI DSS, PCI DSS 4.0
- **Classical Algorithms Referenced**: RSA
- **Key Takeaways**: PCI DSS 4.0 does not yet mandate PQC algorithms; Requirement 12.3.3 cipher inventory mandate is firm as of April 1, 2025; EMVCo chip authentication still relies on RSA; TLS 1.2 remains the PCI DSS minimum since 2018
- **Security Levels & Parameters**: None detected
- **Hybrid & Transition Approaches**: None detected
- **Pure PQC KEM Support**: No
- **Pure PQC KEM Evidence**: None detected
...
- **Source Document**: FIN-004.pdf (1,586,005 bytes, no text extracted)
- **Extraction Timestamp**: 2026-07-17T10:43:59
- **Generation Model**: mlx-community/Qwen3.6-27B-8bit (mlx)
...
- **PQC Round**: Standardised
- **Source Document**: GOV-003.html (72,793 bytes, 11,822 extracted chars)
- **Extraction Timestamp**: 2026-07-17T10:45:05
- **Generation Model**: mlx-community/Qwen3.6-27B-8bit (mlx)
...
- **Math Family**: None detected
- **PQC Round**: Not Applicable
- **Source Document**: AUS-GOV-001.html (482,289 bytes, 14,481 extracted chars)
- **Extraction Timestamp**: 2026-07-17T10:45:06
- **Generation Model**: mlx-community/Qwen3.6-27B-8bit (mlx)
...
- **Math Family**: None detected
- **PQC Round**: Not Applicable
- **Source Document**: HLTH-001.html (145,863 bytes, 16,099 extracted chars)
...
- **Math Family**: Lattice; Hash-based
- **PQC Round**: Standardised
- **Source Document**: IT-001.html (34,496 bytes, 1,685 extracted chars)
...
- **Math Family**: Lattice; Hash-based
- **PQC Round**: Standardised
- **Source Document**: IT-003.html (61,179 bytes, 5,588 extracted chars)
...
- **Math Family**: None detected
- **PQC Round**: Not Applicable
- **Source Document**: SUPPLY-001.html (57,115 bytes, 3,305 extracted chars)
- **Extraction Timestamp**: 2026-07-17T10:45:13
- **Generation Model**: mlx-community/Qwen3.6-27B-8bit (mlx)
...
- **Math Family**: None detected
- **PQC Round**: Not Applicable
- **Source Document**: SUPPLY-003.html (67,968 bytes, 13,679 extracted chars)
- **Extraction Timestamp**: 2026-07-17T10:45:14
- **Generation Model**: mlx-community/Qwen3.6-27B-8bit (mlx)
...
- **Last Updated**: Not specified
- **Document Status**: active
- **Main Topic**: Overview of PQC integration efforts in 3GPP Release 19 and 20, ETSI QSC guidance, and 6G standardization targets.
- **PQC Algorithms Covered**: None detected
- **Quantum Threats Addressed**: None detected
- **Migration Timeline Info**: 6G standardization target: 2030; Normative PQC requirements expected in 3GPP Release 20 or later
- **Applicable Regions / Bodies**: Bodies: 3GPP, ETSI
- **Leaders Contributions Mentioned**: None detected
- **PQC Products Mentioned**: None detected
- **Protocols Covered**: None detected
- **Infrastructure Layers**: None detected
- **Standardization Bodies**: 3GPP; ETSI
- **Compliance Frameworks Referenced**: None detected
- **Classical Algorithms Referenced**: None detected
- **Key Takeaways**: 3GPP Release 19 includes a Study Item for PQC but no binding mandates; Normative PQC requirements are expected in Release 20 or later; ETSI ISG QSC has published guidance documents in the GR QSC series; 6G standardization targets 2030 to build PQC as a baseline requirement
- **Security Levels & Parameters**: None detected
- **Hybrid & Transition Approaches**: None detected
- **Pure PQC KEM Support**: Not Applicable
- **Pure PQC KEM Evidence**: None detected
...
- **PQC Round**: Not Applicable
- **Extraction Note**: No source text available
- **Source Document**: TELCO-005.pdf (245,865 bytes, no text extracted)
- **Extraction Timestamp**: 2026-07-17T10:45:15
- **Generation Model**: mlx-community/Qwen3.6-27B-8bit (mlx)
...
- **Math Family**: None detected
- **PQC Round**: Not Applicable
- **Source Document**: EDU-001.html (133,108 bytes, 13,899 extracted chars)
...
- **PQC Round**: Round 2
- **Source Document**: CROSS-009.html (56,705 bytes, 10,245 extracted chars)
- **Extraction Timestamp**: 2026-07-17T10:46:20
- **Generation Model**: mlx-community/Qwen3.6-27B-8bit (mlx)
...
- **Math Family**: None detected
- **PQC Round**: Not Applicable
- **Source Document**: CROSS-010.html (347,248 bytes, 11,311 extracted chars)
- **Extraction Timestamp**: 2026-07-17T10:46:21
- **Generation Model**: mlx-community/Qwen3.6-27B-8bit (mlx)
...
- **PQC Round**: Standardised
- **Source Document**: CROSS-011.html (11,334 bytes, 11,333 extracted chars)
...
- **Math Family**: None detected
- **PQC Round**: Not Applicable
- **Source Document**: CI-001.html (71,066 bytes, 10,256 extracted chars)
- **Extraction Timestamp**: 2026-07-17T10:46:25
- **Generation Model**: mlx-community/Qwen3.6-27B-8bit (mlx)
...
- **Last Updated**: Not specified
- **Document Status**: active
- **Main Topic**: Stateful hash-based signatures (LMS, HSS) defined in NIST SP 800-208 offer quantum-resistant security for IoT firmware updates where private key state can be maintained.
...
- **Infrastructure Layers**: None detected
- **Standardization Bodies**: NIST
- **Compliance Frameworks Referenced**: NIST SP 800-208; NIST SP 800-213; NISTIR 8259
- **Classical Algorithms Referenced**: None detected
- **Key Takeaways**: Stateful hash-based signatures are viable for IoT firmware updates; Private key state maintenance is required for LMS and HSS; LMS and HSS are preferred for one-time signing scenarios; This approach aligns with NIST IoT cybersecurity guidance
- **Security Levels & Parameters**: None detected
- **Hybrid & Transition Approaches**: None detected
- **Pure PQC KEM Support**: Not Applicable
- **Pure PQC KEM Evidence**: None detected
...
- **QKD Protocols & Quantum Networking**: None detected
- **QRNG & Entropy Sources**: None detected
- **Constrained Device & IoT Suitability**: IoT firmware updates; private key state maintenance required
- **Supply Chain & Vendor Risk**: None detected
- **Deployment & Migration Complexity**: None detected
- **Financial & Business Impact**: None detected
- **Organizational Readiness**: None detected
...
- **PQC Round**: Standardised
- **Extraction Note**: No source text available
- **Source Document**: CROSS-018.pdf (1,427,010 bytes, no text extracted)
- **Extraction Timestamp**: 2026-07-17T10:46:26
- **Generation Model**: mlx-community/Qwen3.6-27B-8bit (mlx)
...
- **Math Family**: None detected
- **PQC Round**: Not Applicable
- **Source Document**: AUS-TEL-001.html (79,783 bytes, 852 extracted chars)
- **Extraction Timestamp**: 2026-07-17T10:47:26
- **Generation Model**: mlx-community/Qwen3.6-27B-8bit (mlx)
