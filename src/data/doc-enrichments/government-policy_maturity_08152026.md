...
- **Governance**:
    ...
    - _T2 Risk-Informed · all_: Establish a dedicated sub-group of experts to define and develop the Coordinated Implementation Roadmap.
- **Lifecycle / CLM**:
    - _T2 Risk-Informed · all_: Define national transition plans aligned with the Coordinated Implementation Roadmap within two years of publication.
- **Observability**:
    - _T2 Risk-Informed · all_: Submit relevant information to the Commission upon request to enable monitoring of transition progress.
