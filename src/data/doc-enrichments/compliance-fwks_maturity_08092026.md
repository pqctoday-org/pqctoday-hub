...
- **Source**: Malaysia National Cryptography Policy and PQC Migration Plan 2025-2030
- **URL**: https://www.nacsa.gov.my/doc/MyKriptografi.pdf
- **Requirement count**: 4
- **Assurance / FIPS**:
    - _T3 Repeatable · libraries_: Implement a national scheme for the assessment, verification, and certification of cryptographic products to ensure they meet government-defined security standards before deployment.
- **Governance**:
    - _T3 Repeatable · all_: Mandate the use of National Trusted Cryptographic Products (PKTN) for all transactions involving Official Secrets and classified data for National Critical Information Infrastructure (NCII) entities.
    - _T3 Repeatable · all_: Establish and enforce a governance framework for cryptographic technology management, including policy structures, legal guidelines, and compliance enforcement mechanisms.
    - _T3 Repeatable · all_: Develop and maintain a national Post-Quantum Cryptography (PQC) readiness plan to address emerging cryptographic threats and ensure long-term security resilience.
