...
- **Key Commitments & Quotes**: "Apple is adopting hybrid cryptography, which combines classic algorithms and new post-quantum algorithms"; "Apple has deployed quantum-secure cryptography across a wide range of protocols"; "Systems support quantum encryption only when they connect to supporting servers"
- **Coverage Verification**: CONSISTENT, the document details expanded PQC support in iOS 26/macOS 26 and references iMessage PQ3, confirming material expansion since 2024.
- **Extraction Quality**: HIGH
- **Source Document**: VND-002_Apple_Inc..html (710.1 KB)
- **Extraction Timestamp**: 2026-07-11T08:10:32
...
- **Target Migration Dates**: JDK 26 in March 2026; JDK 27 for PQC TLS mechanisms
- **Products / Services Covered**: Oracle Database; Oracle AI Database 26ai; Oracle Java; JDK; Oracle Jipher; Oracle Linux; OpenSSL
- **Compliance Frameworks**: FIPS 203; FIPS 204; FIPS 140; CNSA 2.0; RFC 8554; NIST SP 800-208; RFC 9180
- **Hybrid Mode Support**: Yes; implementing hybrid key establishments for TLS 1.3, SSH, and IKE v2
- **Current GA Status**: GA
- **Customer Action Required**: Transition to TLS 1.3; Upgrade to current version
- **Key Commitments & Quotes**: "Oracle is implementing hybrid key establishments for most environments."
- **Coverage Verification**: CONSISTENT; The document details a multi-product strategy, which is consistent with the unspecified CSV notes.
- **Extraction Quality**: HIGH
...
- **Hybrid Mode Support**: Yes; hybrid keys using strong classic KEM and one or more PQCs
- **Current GA Status**: GA
- **Customer Action Required**: Assign resources; define responsibilities; develop cryptographic inventory; evaluate solutions; monitor progress; implement RFC 8784
...
- **Products / Services Covered**: Portfolio-wide commitment (no individual products named)
- **Compliance Frameworks**: None detected
- **Hybrid Mode Support**: Yes; preparing for hybrid environments using both classical and NIST-standardized PQC algorithms
- **Current GA Status**: Planned
...
- **Hybrid Mode Support**: No
- **Current GA Status**: GA
- **Customer Action Required**: Download the wolfSSL library, configure it to enable Dilithium and Kyber and run the benchmarks
...
- **Coverage Verification**: PARTIAL; The document confirms ML-KEM/ML-DSA support in wolfSSL/wolfCrypt but does not mention wolfBoot, wolfPKCS11, or the "on request" availability of SLH-DSA.
- **Extraction Quality**: HIGH
...
- **Coverage Verification**: MISMATCH; The document confirms the roadmap, products, and CNSA 2.0 alignment, but does not explicitly state support for ML-KEM, ML-DSA, or FALCON algorithms.
- **Extraction Quality**: HIGH
...
- **Target Migration Dates**: None detected
- **Products / Services Covered**: Vault; other HashiCorp products
- **Compliance Frameworks**: NIST
- **Hybrid Mode Support**: Yes; research and build support for hybrid schemes
- **Current GA Status**: Planned
- **Customer Action Required**: Institute a post-quantum readiness program/task force; Prioritize and assess high-risk assets/data; Discover and inventory cryptographic usage and dependencies; Enforce zero trust security; Create a migration plan; Establish an ongoing governance program
...
- **Coverage Verification**: CONSISTENT; The document explicitly confirms the staged rollout in Vault transit secrets engine, adoption of the three NIST algorithms, hybrid schemes, and expansion to other products contingent on Go/standards maturity, with no firm dates.
- **Extraction Quality**: HIGH
...
- **Hybrid Mode Support**: No
- **Current GA Status**: Planned
- **Customer Action Required**: Assess cryptographic exposure across systems and data flows, and prioritize sensitive data requiring long-term protection.
...
- **Coverage Verification**: PARTIAL; The document confirms the Dec 2026 portfolio-wide commitment but does not mention Robust Intelligence, IOS XE, FTD, ASA, or specific algorithms like ML-KEM.
- **Extraction Quality**: MEDIUM
...
- **PQC Algorithms Announced**: None detected
- **Target Migration Dates**: None detected
- **Products / Services Covered**: SKA Platform; SKA Edge Controller; SKA Central Controller; Network Security; PQC Migration
- **Compliance Frameworks**: FIPS
- **Hybrid Mode Support**: Yes; standards-based hybrid approach
- **Current GA Status**: GA
- **Customer Action Required**: None detected
- **Key Commitments & Quotes**: "Arqit’s use of PQAs is limited to initial provisioning and customers can opt for symmetric-only provisioning"; "Our standards-based hybrid approach maximizes compatibility, offers cryptoagility, and minimizes risk"; "Arqit’s protocols have been formally validated using the Tamarin prover method"
- **Coverage Verification**: PARTIAL; The document confirms SKA Platform, controllers, Network Security, FIPS, hybrid/crypto-agility, symmetric-only provisioning, and Tamarin verification, but does not explicitly name "PQC Migration / Encryption Intelligence" or "NetworkSecure" as distinct product titles, nor does it mention 2024-2025 awards.
- **Extraction Quality**: MEDIUM
...
- **Hybrid Mode Support**: Yes; CRYSTALS-Kyber + X25519 for encryption, CRYSTALS-Dilithium + Ed25519 for signatures
- **Current GA Status**: Planned
- **Customer Action Required**: None detected
- **Key Commitments & Quotes**: "Proton is leading the standardization of quantum-safe encryption algorithms in OpenPGP"; "We will roll this out well before quantum computers become a threat"; "Proton Mail encrypted email will be safe thanks to post-quantum cryptography"
