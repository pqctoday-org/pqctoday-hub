...
/** Per-record GitHub Discussions signal — see `src/data/communitySignalsData.ts`. */
...
export interface ScoringContext {
  ...
  /**
   * Aggregated GitHub Discussions endorsements/flags per `${resourceType}:${resourceId}`.
   * Populated from `src/data/community-signals.json` (regenerated by
   * `scripts/fetch-community-signals.ts`). Empty Map when no signals exist.
   */
  communitySignals: Map<string, CommunitySignal>
}
