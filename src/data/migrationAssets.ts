...
export const REPLACE_ASSETS: ReplaceAsset[] = [
  ...
  },
  {
    ...
    note: 'Issue hybrid / composite certificates (ML-DSA-87 + ECDSA) during transition. CNSA 2.0 mandates ML-DSA-87 (Level 5) for all signatures. Requires CA + relying-party support; plan a dual-trust period.',
    focusPersonas: ['architect'],
  },
  {
    id: 'ssh',
