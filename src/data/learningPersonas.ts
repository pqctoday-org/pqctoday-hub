...
export const PERSONAS: Record<PersonaId, LearningPersona> = {
  ...
  developer: {
    ...
    pathItems: [
      ...
      { type: 'module', moduleId: 'dnssec-pqc' },
    ...
    quizDescription:
      'Test your knowledge on quantum threats, TLS, VPN/SSH, DNSSEC, MLS group messaging, PKI enrollment, cryptographic APIs, hybrid cryptography, crypto agility, PQC testing & validation, protocol integration, cryptographic management modernization, SLH-DSA, and stateful hash signatures.',
    quizCategories: [
      'pqc-fundamentals',
      'dev-quantum-impact',
      'quantum-threats',
  ...
  architect: {
    ...
    pathItems: [
      ...
      { type: 'module', moduleId: 'automotive-pqc' },
      {
        ...
        categories: ['api-security-jwt', 'code-signing', 'iot-ot-pqc', 'automotive-pqc'],
      },
      { type: 'module', moduleId: 'quiz' },
    ],
