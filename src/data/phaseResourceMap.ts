...
export const BUSINESS_PHASES: Record<string, PhaseResource> = {
  ...
  'audit-checklist': {
    phasesServed: ['foundations', 'verify-close'],
  ...
  'kpi-tracker': { phasesServed: ['foundations', 'verify-close'], legs: ['practice', 'output'] },
  ...
  'crypto-cbom-builder': { phasesServed: ['p2', 'verify-close'], legs: ['practice', 'output'] },
