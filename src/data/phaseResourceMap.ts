...
export const LEARN_PHASES: Record<string, PhaseResource> = {
  ...
  'crypto-agility': { phasesServed: ['p1', 'p2', 'foundations'], legs: ['learn', 'reference'] },
  'crypto-mgmt-modernization': {
    phasesServed: ['p1', 'p2', 'foundations'],
  ...
  'pqc-risk-management': { phasesServed: ['p1', 'p3'], legs: ['learn', 'reference'] },
  'pqc-business-case': { phasesServed: ['p0'], legs: ['learn', 'reference'] },
  'pqc-governance': { phasesServed: ['p0', 'p1'], legs: ['learn', 'reference'] },
  'pqc-team': { phasesServed: ['foundations'], legs: ['learn', 'reference'] },
  'vendor-risk': { phasesServed: ['p2', 'p7'], legs: ['learn', 'reference'] },
  'migration-program': { phasesServed: ['p1', 'p3', 'p4', 'p5'], legs: ['learn', 'reference'] },
  'compliance-strategy': {
    phasesServed: ['p1', 'p2', 'foundations'],
    legs: ['learn', 'reference'],
  },
  'data-asset-sensitivity': {
    phasesServed: ['p1', 'p3', 'foundations'],
    legs: ['learn', 'reference'],
  },
  'confidential-computing': { phasesServed: ['p6'], legs: ['learn', 'reference'] },
  'database-encryption-pqc': { phasesServed: ['p2', 'p6'], legs: ['learn', 'reference'] },
  ...
  'automotive-pqc': { phasesServed: ['p1', 'p5'], legs: ['learn', 'reference'] },
  'healthcare-pqc': { phasesServed: ['p2', 'p5'], legs: ['learn', 'reference'] },
  'exec-quantum-impact': { phasesServed: ['p0', 'p1', 'p2'], legs: ['learn', 'reference'] },
  'dev-quantum-impact': { phasesServed: ['p1', 'p2', 'foundations'], legs: ['learn', 'reference'] },
  'arch-quantum-impact': { phasesServed: ['p2', 'foundations'], legs: ['learn', 'reference'] },
  'ops-quantum-impact': { phasesServed: ['p1', 'foundations'], legs: ['learn', 'reference'] },
  ...
  'pqc-testing-validation': {
    phasesServed: ['p1', 'p2', 'p6'],
    legs: ['learn', 'practice', 'reference'],
  },
  'iam-pqc': { phasesServed: ['p1', 'p5'], legs: ['learn', 'reference'] },
  'secure-boot-pqc': { phasesServed: ['p6'], legs: ['learn', 'reference'] },
  'os-pqc': { phasesServed: ['p1', 'p6'], legs: ['learn', 'reference'] },
  'soc-implementation-pqc': { phasesServed: ['p1', 'p2', 'p6'], legs: ['learn', 'reference'] },
  'pqc-grc': { phasesServed: ['p2', 'foundations'], legs: ['learn', 'reference'] },
  'skills-team-structure': { phasesServed: ['p2', 'foundations'], legs: ['learn', 'reference'] },
  'standards-bodies': { phasesServed: ['p4', 'p7', 'foundations'], legs: ['learn', 'reference'] },
...
export const BUSINESS_PHASES: Record<string, PhaseResource> = {
  ...
  'crypto-architecture-diagram': { phasesServed: ['p0'], legs: ['practice', 'output'] },
...
export const PLAYGROUND_PHASES: Record<string, PhaseResource> = {
  ...
  // Sandbox scenarios (sbx-*) — real protocol/system sandboxes that emit
  // handshake/cert/IKE/log artifacts. Phase by content.
  'sbx-pki': { phasesServed: ['p6'], legs: ['practice', 'output'] },
  'sbx-vpn': { phasesServed: ['p5'], legs: ['practice', 'output'] },
  'sbx-browser-tls': { phasesServed: ['p5'], legs: ['practice', 'output'] },
  'sbx-smime': { phasesServed: ['p5'], legs: ['practice', 'output'] },
  'sbx-pqcflow': { phasesServed: ['p5'], legs: ['practice', 'output'] },
  'sbx-osslsigncode': { phasesServed: ['p5'], legs: ['practice', 'output'] },
  'sbx-firmware-hss': { phasesServed: ['p5'], legs: ['practice', 'output'] },
  'sbx-stepca': { phasesServed: ['p6'], legs: ['practice', 'output'] },
  'sbx-besu': { phasesServed: ['p5'], legs: ['practice', 'output'] },
  'sbx-algorand': { phasesServed: ['p5'], legs: ['practice', 'output'] },
  'sbx-database-postgres': { phasesServed: ['p6'], legs: ['practice', 'output'] },
  'sbx-tls': { phasesServed: ['p5'], legs: ['practice', 'output'] },
  'sbx-ssh': { phasesServed: ['p5'], legs: ['practice', 'output'] },
  'sbx-cert-validation': { phasesServed: ['p6'], legs: ['practice', 'output'] },
  'sbx-migration-impact': { phasesServed: ['p3'], legs: ['practice', 'output'] },
  'sbx-cloud-kms': { phasesServed: ['p6'], legs: ['practice', 'output'] },
  'sbx-dnssec': { phasesServed: ['p6'], legs: ['practice', 'output'] },
  'sbx-crypto-discovery': { phasesServed: ['p1'], legs: ['practice', 'output'] },
  'sbx-qkdsim': { phasesServed: ['p6'], legs: ['practice', 'output'] },
  'sbx-sequence': { phasesServed: ['p5'], legs: ['practice', 'output'] },
  'sbx-openqkd': { phasesServed: ['p6'], legs: ['practice', 'output'] },
  'sbx-sequoia': { phasesServed: ['p5'], legs: ['practice', 'output'] },
  'sbx-web3': { phasesServed: ['p5'], legs: ['practice', 'output'] },
  'sbx-cosmian-kms': { phasesServed: ['p6'], legs: ['practice', 'output'] },
  'sbx-sops': { phasesServed: ['p6'], legs: ['practice', 'output'] },
  'sbx-hybrid-certs': { phasesServed: ['p5', 'p6'], legs: ['practice', 'output'] },
  'sbx-haproxy': { phasesServed: ['p5', 'p6'], legs: ['practice', 'output'] },
  'sbx-chronyd': { phasesServed: ['p6'], legs: ['practice', 'output'] },
  'sbx-wireguard': { phasesServed: ['p5'], legs: ['practice', 'output'] },
  'sbx-api-security-jwt': { phasesServed: ['p5'], legs: ['practice', 'output'] },
  'sbx-iot-mqtt': { phasesServed: ['p5'], legs: ['practice', 'output'] },
  'sbx-secrets-vault': { phasesServed: ['p6'], legs: ['practice', 'output'] },
  'sbx-confidential-computing': { phasesServed: ['p6'], legs: ['practice', 'output'] },
  'sbx-supply-chain-signing': { phasesServed: ['p5', 'p7'], legs: ['practice', 'output'] },
  'sbx-cbom-compliance': { phasesServed: ['p2'], legs: ['practice', 'output'] },
  'sbx-tpm-pqc-migration': { phasesServed: ['p6'], legs: ['practice', 'output'] },
}
