...
const TREE: PhaseTree = {
  ...
  "levels": [
    ...
    {
      "level": 2,
      "indicator": "Top 10 vendors formally engaged; questionnaires sent; responses tracked; vendor criticality classification complete",
      "activities": [
        {
          "id": "7.2",
    ...
    {
      "level": 3,
      "indicator": "PQC in standard procurement language; contracts include dated commitments and remedies; bridging patterns deployed for blocked systems; vendor scorecard reported to SteerCo",
      "activities": [
        {
          "id": "7.3",
    ...
    {
      "level": 4,
      "indicator": "All strategic vendors PQC-committed with verified delivery; bridging patterns eliminated as vendor support matures; open-source dependency tracking operational; vendor governance is permanent BAU function",
      "activities": [
        {
          "id": "7.7",
