...
// GENERATED by scripts/gen-sim-trees.mjs on 06232026 — do not edit by hand.
...
const TREE: PhaseTree = {
  ...
  "levels": [
    ...
    {
      "level": 2,
      "indicator": "Maturity self-assessment run; KPI baseline set; crypto-agility plan and skills plan drafted",
      "activities": [
        {
          "id": "F.2",
    ...
    {
      "level": 3,
      "indicator": "KPIs reported to the board; regulatory/standards alignment maintained; crypto-agility OKRs tracked; evidence dossier kept",
      "activities": [
        {
          "id": "F.4",
    ...
    {
      "level": 4,
      "indicator": "Foundations run as BAU; migration verification & program-closure standard applied; algorithm changes are routine",
      "activities": [
        {
          "id": "F.5",
