...
const TREE: PhaseTree = {
  ...
  "levels": [
    ...
    {
      "level": 2,
      "indicator": "Multi-year roadmap approved; Year 1 plan resourced; SteerCo operational; KPI baseline set",
      "activities": [
        {
          "id": "4.2",
    ...
    {
      "level": 3,
      "indicator": "Quarterly roadmap reviews operational; dependency mapping maintained; refresh cycle alignment documented; vendor engagement tracked on dashboard",
      "activities": [
        {
          "id": "4.5–4.6",
    ...
    {
      "level": 4,
      "indicator": "Roadmap is a living instrument with quarterly updates; contingency triggers defined and tested; leading indicators monitored; program transitioning from migration execution to ongoing posture management",
      "activities": [
        {
          "id": "4.7",
