...
const TREE: PhaseTree = {
  ...
  "levels": [
    {
      "level": 1,
      "indicator": "Closure discussed on milestones; no evidence standard applied; \"done\" is declared, not proven",
      "activities": [
        {
          "id": "VC.1",
    ...
    {
      "level": 2,
      "indicator": "Migration verified against the 5-point evidence standard; classical key material decommissioning logged (SP 800-88); program closure record produced",
      "activities": [
        {
          "id": "VC.2",
    ...
    {
      "level": 3,
      "indicator": "Independent verification of Tier-1 systems; crypto-agility/rollback drill evidenced; executive-sponsor sign-off; BAU handover funded",
      "activities": [
        {
          "id": "VC.3",
    ...
    {
      "level": 4,
      "indicator": "Verification & closure run as BAU; evidence dossier continuously maintained; decommissioning and attestations folded into posture monitoring",
      "activities": [
        {
          "id": "VC.4",
