...
const TREE: PhaseTree = {
  ...
  "levels": [
    {
      "level": 2,
      "indicator": "HSMs inventoried with PQC status; PKI modernization plan drafted; initial middlebox testing underway",
      "activities": [
        {
          "id": "6.1",
    ...
    {
      "level": 3,
      "indicator": "HSM upgrades in progress; PKI dual-stack operational; all production middleboxes tested; performance baselines established for Tier-1 systems",
      "activities": [
        {
          "id": "6.4",
