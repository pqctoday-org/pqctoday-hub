...
const TREE: PhaseTree = {
  ...
  "levels": [
    {
      "level": 1,
      "indicator": "Informal awareness of which systems are \"probably vulnerable\"; no structured scoring",
      "activities": [
        {
          "id": "3.1",
    ...
    {
      "level": 2,
      "indicator": "Formal risk scoring model applied to Tier-1 CBOM entries; prioritized migration backlog exists; QRA document produced",
      "activities": [
        {
          "id": "3.2",
