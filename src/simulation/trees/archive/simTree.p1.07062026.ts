      ...
      activities: [
        {
          ...
          deepDive: [
            {
              kind: 'workshop',
              label: 'Deep dive — Practice: RNG demo (deterministic vs true randomness)',
              to: '/playground/rng-demo',
              workshopId: 'rng-demo',
            },
            {
              kind: 'workshop',
              label: 'Deep dive — Practice: entropy testing',
              to: '/playground/entropy-test',
              workshopId: 'entropy-test',
            },
            {
              kind: 'workshop',
              label: 'Deep dive — Practice: QRNG demo',
              to: '/playground/qrng-demo',
              workshopId: 'qrng-demo',
            },
            {
              kind: 'workshop',
              label: 'Deep dive — Practice: combining entropy sources',
              to: '/playground/source-combining',
              workshopId: 'source-combining',
            },
            {
              kind: 'workshop',
              label: 'Deep dive — Practice: SP 800-90A DRBG',
              to: '/playground/drbg-demo',
              workshopId: 'drbg-demo',
            },
            {
              kind: 'learn',
