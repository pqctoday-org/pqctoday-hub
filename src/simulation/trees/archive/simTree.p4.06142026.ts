...
const TREE: PhaseTree = {
  ...
  levels: [
      ...
      activities: [
        ...
        },
        {
          ...
          steps: [
            {
              kind: 'activity',
              label: 'Build the compliance timeline',
              to: '/business/tools/compliance-timeline',
              artifactType: 'compliance-timeline',
            },
          ],
        },
        {
    ...
    },
    {
      level: 4,
      indicator:
        'Roadmap is a living instrument with quarterly updates; contingency triggers defined and tested; leading indicators monitored',
      activities: [
        {
          id: '4.7',
          ...
          steps: [
            {
              kind: 'reference',
              label: 'Tie acceleration triggers to compliance deadlines',
              to: '/compliance',
              refId: 'compliance',
            },
          ],
