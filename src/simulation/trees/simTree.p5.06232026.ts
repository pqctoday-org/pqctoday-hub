...
const TREE: PhaseTree = {
  ...
  "levels": [
    ...
    {
      "level": 2,
      "indicator": "2+ production pilots running with measured results; rollback procedures tested; validated patterns documented",
      "activities": [
        {
          "id": "5.3",
    ...
    {
      "level": 3,
      "indicator": "Tier-1 internet-facing systems on hybrid/PQC; wave rollout underway for Tier-2; defense-in-depth measures (tokenization, AES-256, segmentation) deployed",
      "activities": [
        {
          "id": "5.4",
    ...
    {
      "level": 4,
      "indicator": "Estate-wide hybrid/PQC deployment substantially complete; transitioning selected systems from hybrid to PQC-only; crypto-agility demonstrated via algorithm-swap drill",
      "activities": [
        {
          "id": "5.7",
