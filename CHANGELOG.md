...
- **Rate your program maturity across seven domains** [view:/assess] [view:/report] [view:/business] [persona:executive]: a new self-assessment on the Assess page scores you 0–5 across inventory, governance, pilots, vendors, compliance, crypto-agility and risk — your overall level is your weakest domain ("a chain is only as strong as its weakest link") — and it now follows you as a summary on the Report and in the Command Center.
